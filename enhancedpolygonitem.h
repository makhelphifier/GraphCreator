#ifndef ENHANCEDPOLYGONITEM_H
#define ENHANCEDPOLYGONITEM_H

#include <QGraphicsPathItem>

class EnhancedPolygonItem : public QGraphicsPathItem {
public:
    EnhancedPolygonItem();
...
private:
    ...
    HandlePosition currentHandlePosition(const QPointF &pos);
    HandlePosition m_activeHandle;
    QString handleToString(HandlePosition handle);
