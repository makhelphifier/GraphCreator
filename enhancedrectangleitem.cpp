...
void EnhancedRectangleItem::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    if(option->state&QStyle::State_Selected){
        QRectF boundRect = this->rect().adjusted(-2,-2,2,2);
        QPen selectionBoxPen(Qt::black,0.2,Qt::DotLine);
...
EnhancedRectangleItem::HandlePosition EnhancedRectangleItem::currentHandlePosition(const QPointF &pos)
{
    qreal handleSize = 4;
...
{
    switch (handle) {
    case EnhancedRectangleItem::None: return "None";
    case EnhancedRectangleItem::TopLeft: return "TopLeft";
    case EnhancedRectangleItem::TopMiddle: return "TopMiddle";
    case EnhancedRectangleItem::TopRight: return "TopRight";
    case EnhancedRectangleItem::MiddleLeft: return "MiddleLeft";
    case EnhancedRectangleItem::MiddleRight: return "MiddleRight";
    case EnhancedRectangleItem::BottomLeft: return "BottomLeft";
    case EnhancedRectangleItem::BottomMiddle: return "BottomMiddle";
    case EnhancedRectangleItem::BottomRight: return "BottomRight";
    case EnhancedRectangleItem::RotationHandle: return "RotationHandle";
